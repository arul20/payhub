...
class PayHubModelActions extends JModel{
    protected $_items;
    private $_table;
    static private $_tableName = '#__payhub_actions';
    ...
    public function getExtensions(){
        $db =& JFactory::getDbo();
        $extension = $db->nameQuote('extension');
        $query = "SELECT DISTINCT ".$extension." FROM ".$this->_table.' GROUP BY '.$extension;
        $db->setQuery($query);
        $this->_items = $db->loadObjectList();
        return $this->_items;
    }
