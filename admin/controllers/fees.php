...
class PayHubControllerFees extends JController{
    
    public static $modelName = 'fee';
    public static $viewName = 'fee';
    
    public function display(){
        //Set Default View and Model
        $view =& $this->getView( 'fees', 'html' );
    ...
    public function unpublish(){
        $cids = JRequest::getVar('cid', null, 'default', 'array');
        if( $cids === null ){
            JError::raiseError( 500, 'Nothing were selected for unpublish' );
        }
