...
class PayHubControllerItems extends JController{
    
    public static $modelName = 'item';
    public static $viewName = 'item';
    ...
    function save(){
        ...
        $redirectTo = JRoute::_('index.php?option='.JRequest::getVar('option').$view.'&task=display');
