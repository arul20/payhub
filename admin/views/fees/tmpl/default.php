        ...
        <thead>
            <tr>
                ...
                <input type="checkbox"
                    ...
                    <?php echo count( $this->fees ); ?>);" 
                />
                </th>
                <th><?php echo JText::_('Title'); ?></th>
                <th width="15%"><?php echo JText::_('SKU'); ?></th>
                <th width="10%"><?php echo JText::_('Price'); ?></th>
                <th width="8%" align="center"><?php echo JText::_('VAT'); ?></th>
                <th width="5%" align="center"><?php echo JText::_('Published'); ?></th>
                <th width="5%" align="center"><?php echo JText::_('Created'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td>
                    <?php
                    echo JHTML::_('date', $row->created, JTEXT::_('m/d/Y'));
                    ?>
                </td>
            </tr>
            <?php
